...
[نسخه فارسی](https://github.com/H0sseini/v2ray-worker/blob/main/README-fa.md)
...
[![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/H0sseini/v2ray-worker)
